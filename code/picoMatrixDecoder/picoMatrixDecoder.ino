/*
This is an adapted version of Frank Adam's keyboard matrix decoder, made to work with the rPi-pico.
*/
...
// on the laptop keyboard that will be tested. Connect the FPC cable of the test keyboar
...
//
int max_pin = 33; // the keyboard FPC connector pin count. If set to 34, unsolder the LED orthe code won't work
